...
# Purpose:     Master Execution Script - Interactive Mode
# Author:      CM
# Date:        July 2017
# Language:    Shell (.sh)
...
#----------------------------------------------------------------------------#
printf "\n# Settings\n\n"
source code_base/machine_code/user_setting.sh 
...
--text "Starting the Analysis" ‑‑no‑timeout \
...
#----------------------------------------------------------------------------#
$CD bubble --title "Email Analyser" \
--text "Successfully Completed - (output_${current_date}_${execution_id})" ‑‑no‑timeout \
--background-top "F8F8F8" --background-bottom "F8F8F8" --border-color "F8F8F8" \
--icon-file "${wd_path_helper}/icon/icon_temp.png"
